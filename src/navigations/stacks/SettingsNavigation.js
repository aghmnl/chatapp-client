...
export function SettingsNavigation() {
  return (
    <Stack.Navigator screenOptions={{ ...styles.stackNavigationStyles }}>
      <Stack.Screen name={screens.tab.settings.settingScreen} component={SettingsScreen} options={{ headerShown: false }} />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        options={{ title: "Cambiar apellidos", presentation: "modal" }}
      />
    </Stack.Navigator>
  );
}
